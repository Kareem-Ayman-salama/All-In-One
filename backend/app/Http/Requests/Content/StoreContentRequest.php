...
class StoreContentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'type' => [
                'required',
                Rule::in(['file', 'pdf', 'image', 'video', 'youtube', 'link']),
            ],
            'file' => [
                'required_unless:type,link,youtube',
                'file',
                'max:'.config('uploads.max_kilobytes'),
                new SecureContentFile($contentType),
            ],
            'externalUrl' => ['required_if:type,link,youtube', 'nullable', 'url:http,https', 'max:2048'],
            'downloadAllowed' => ['nullable', 'boolean'],
            'watermarkEnabled' => ['nullable', 'boolean'],
            'allowFullscreen' => ['nullable', 'boolean'],
            'displayOrder' => ['nullable', 'integer', 'min:0', 'max:100000'],
